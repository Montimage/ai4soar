...
from core.api.routes import kafka_bp
from core.services import KafkaService
...
def publish_alerts():
    ...
    try:
        ...
        kafka_service.publish_alert(scenario.lower(), data)
...
def publish_responses_with_alert_stix():
    ...
    try:
        ...
        kafka_service.publish_stix_response(scenario.lower(), response_body, triaged_alert)
...
def publish_message_to_hm():
    ...
    try:
        ...
        kafka_service.publish_message_to_honeypot_manager(scenario.lower(), message)
        return jsonify({
            'status': 'success',
...
def consume_alerts():
    ...
    try:
        ...
        message = kafka_service.consume_alerts(scenario.lower())
